sonar-scanner.bat -D"sonar.organization=testepsicodemain" -D"sonar.projectKey=testepsicodemain_shuttle-music-player"  -D"sonar.sources=." -D"sonar.host.url=https://sonarcloud.io"  -D"sonar.java.binaries=."
