...
import com.simplecity.amp_library.ui.adapters.SectionedAdapterUI
...
class AlbumArtistListFragment :
    ...
    private lateinit var adapter: SectionedAdapterUI
    ...
    fun interface AlbumArtistClickListener {
