...
public class LoggingViewModelAdapter extends ViewModelAdapter {
    ...
    private static final String LOGGING_TAG = "LoggingVMAdapter";
    ...
    public synchronized Disposable setItems(List<ViewModel> items, @Nullable CompletionListUpdateCallback callback) {
        ...
        Crashlytics.log(Log.DEBUG, LOGGING_TAG, String.format("setItems called for: '%s'", tag));
        ...
        return super.setItems(items, new CompletionListUpdateCallback() {
            ...
            public void onComplete() {
                ...
                Crashlytics.log(Log.DEBUG, LOGGING_TAG, String.format("setItems complete for: '%s'. Dispatching updates.", tag));
