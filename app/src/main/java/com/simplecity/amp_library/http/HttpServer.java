    ...
    private class NanoServer extends NanoHTTPD {
        ...
        public Response serve(IHTTPSession session) {
            ...
            if (audioFileToServe == null) {
                ...
                return newFixedLengthResponse(Response.Status.NOT_FOUND, MIME_TYPES.get("html"), "File not found");
            }
            ...
            if (uri.contains("audio")) {
                try {
                    ...
                    if (start <= end) {
                        ...
                        return newFixedLengthResponse(Response.Status.RANGE_NOT_SATISFIABLE, MIME_TYPES.get("html"), range);
                    }
                } catch (IOException e) {
                ...
                if (imageBytesToServe == null) {
                    return newFixedLengthResponse(Response.Status.NOT_FOUND, MIME_TYPES.get("html"), "Image bytes null");
                }
                cleanupImageStream();
