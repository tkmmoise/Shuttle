...
public class PlayCountTable extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 2) {
            ...
            final String TABLE_BACKUP = "BACKUP";
            ...
            try {
                final String COUNT_INFO_DATABASE = "count_info.db";
                final String PATH_COUNT_INFO = applicationContext.getDatabasePath(COUNT_INFO_DATABASE).toString();
                final String TABLE_COUNT_INFO = "COUNT_INFO";
                final String COUNT_INFO_COLUMN_ID = "_id";
                final String COUNT_INFO_COLUMN_TIME_PLAYED = COLUMN_TIME_PLAYED;
