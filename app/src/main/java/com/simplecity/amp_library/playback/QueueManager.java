        ...
        return songsRepository.getAllSongs()
                ...
                .subscribe((UnsafeConsumer<List<QueueItem>>) queueItems -> {
                    ...
                    if (queueList != null) {
                        ...
                        final int localQueuePosition = playbackSettingsManager.getQueuePosition();

                        if (localQueuePosition < 0 || localQueuePosition >= playlist.size()) {
                        ...
                        QueueManager.this.queuePosition = localQueuePosition;
                        ...
                        if (shuffleMode == ShuffleMode.ON) {
                            ...
                            if (queueList != null) {
                                ...
                                if (localQueuePosition >= shuffleList.size()) {
                                    // The saved playlist is bogus, discard it
                                    shuffleList.clear();
                                    queueReloading = false;
                                    onComplete.invoke();
