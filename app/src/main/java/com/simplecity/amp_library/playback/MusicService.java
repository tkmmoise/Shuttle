...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    public void onCreate() {
        ...
        Intent localShutdownIntent = new Intent(this, MusicService.class);
        localShutdownIntent.setAction(ServiceCommand.SHUTDOWN);

        alarmManager = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
        this.shutdownIntent = PendingIntent.getService(this, 0, localShutdownIntent, 0);
