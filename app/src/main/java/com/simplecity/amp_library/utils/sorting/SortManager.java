...
public class SortManager {
    ...
    public final class Key {
        public static final String ARTISTS = "key_artists_sort_order_" + PREF_VERSION;
        public static final String ALBUMS = "key_albums_sort_order_" + PREF_VERSION;
        public static final String SONGS = "key_songs_sort_order_" + PREF_VERSION;

        public static final String ARTIST_DETAIL_ALBUMS = "key_detail_albums_sort_order_" + PREF_VERSION;
        public static final String PLAYLIST_DETAIL_ALBUMS = "key_detail_playlist_albums_sort_order_" + PREF_VERSION;
        public static final String GENRE_DETAIL_ALBUMS = "key_genre_albums_sort_order_" + PREF_VERSION;

        public static final String ARTIST_DETAIL_SONGS = "key_detail_songs_sort_order_" + PREF_VERSION;
        public static final String ALBUM_DETAIL_SONGS = "key_detail_album_songs_sort_order_" + PREF_VERSION;
        public static final String PLAYLIST_DETAIL_SONGS = "key_detail_playlist_songs_sort_order_" + PREF_VERSION;
        public static final String GENRE_DETAIL_SONGS = "key_genre_songs_sort_order_" + PREF_VERSION;

        public static final String ARTISTS_ASC = "key_artists_sort_order_asc_" + PREF_VERSION;
        public static final String ALBUMS_ASC = "key_albums_sort_order_asc_" + PREF_VERSION;
        public static final String SONGS_ASC = "key_songs_sort_order_asc_" + PREF_VERSION;

        public static final String ARTIST_DETAIL_SONGS_ASC = "key_artist_detail_songs_sort_order_asc_" + PREF_VERSION;
        public static final String ALBUM_DETAIL_SONGS_ASC = "key_album_detail_songs_sort_order_asc_" + PREF_VERSION;
        public static final String PLAYLIST_DETAIL_SONGS_ASC = "key_playlist_songs_sort_order_asc_" + PREF_VERSION;
        public static final String GENRE_DETAIL_SONGS_ASC = "key_genre_songs_sort_order_asc_" + PREF_VERSION;

        public static final String ARTIST_DETAIL_ALBUMS_ASC = "key_detail_albums_sort_order_asc_" + PREF_VERSION;
        public static final String PLAYLIST_DETAIL_ALBUMS_ASC = "key_detail_playlist_albums_sort_order_asc_" + PREF_VERSION;
        public static final String GENRE_DETAIL_ALBUMS_ASC = "key_detail_genre_albums_sort_order_asc_" + PREF_VERSION;
    ...
    public final class SortFolders {
        public static final String DEFAULT = "default";
